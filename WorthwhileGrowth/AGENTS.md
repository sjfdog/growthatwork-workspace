# Worthwhile Growth Agent Guide

This file is for AI agents or engineers arriving cold.

## First Principles

- This folder is project one inside the Growth@Work umbrella.
...
- This project family includes the marketing site, Worthwhile Growth Index, and WayFinder experiments.
- The RIA campaign is a separate Growth@Work project at `/home/spencerf/Documents/Projects/Work/DAllman/GrowthAtWork/RIACampaign`.
- Do not add RIA campaign app code to this project unless the user explicitly changes that decision.
